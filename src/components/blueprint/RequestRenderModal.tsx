...
import { RenderType, RenderMedia, RenderAsset, RenderRequest } from '@/types/render';
import { BlueprintUnit } from '@/lib/types/blueprint';
            ...
            <div className="relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <form id="request-form" onSubmit={handleSubmit} className="flex-1 overflow-y-auto custom-scrollbar p-8 space-y-8">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-1.5 p-4 rounded-xl bg-slate-50 border border-slate-100">
                            <label className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">{unitName ? 'Unit' : (towerName ? 'Tower' : 'Builder')}</label>
                            <div className="text-sm font-bold text-slate-700">{unitName || towerName || builderName}</div>
                        </div>
                    </div>
