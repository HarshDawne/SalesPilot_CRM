...
export default function PropertyForm({ initialData, isEditMode = false }: PropertyFormProps) {
    ...
    const { register, handleSubmit, control, watch, formState: { errors }, reset } = useForm<Property>({
        defaultValues: {
            isActive: true,
            totalTowers: 1,
            totalUnits: 0,
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                ...
                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-1">
                        <label className="text-sm font-medium text-slate-700">Project Type <span className="text-red-500">*</span></label>
                        <select
                            {...register("projectType", { required: "Type is required" })}
