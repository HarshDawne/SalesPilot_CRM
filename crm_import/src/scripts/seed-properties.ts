...
async function seed() {
    ...
    const properties = [
        ...
        },
        {
            ...
            totalTowers: 1, // Represents the whole phase/sector
    ...
    for (const prop of properties) {
        try {
            ...
            if (!propRes.ok) throw new Error(`Property creation failed: ${propRes.statusText}`);
            ...
            console.error(`❌ Failed to seed ${prop.name}:`, err);
        }
    }
